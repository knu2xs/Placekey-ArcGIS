...
SETLOCAL
SET PROJECT_DIR=%cd%
SET PROJECT_NAME=placekey-arcgis
SET SUPPORT_LIBRARY = placekey_arcgis
SET ENV_NAME=placekey-arcgis
...
:build_upload
    ENDLOCAL & (
        ...
        :: Build conda package
        CALL conda build ./conda-recipe --output-folder ./conda-recipe/conda-build
        CALL anaconda upload ./conda-recipe/conda-build/win-64/placekey-arcgis*.tar.bz2
